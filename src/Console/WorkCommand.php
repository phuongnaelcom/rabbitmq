...
namespace phuongna\rabbitmq\Console;

use phuongna\rabbitmq\Worker;
...
class WorkCommand extends Command
{
     ...
     * @var string
     */
    protected $defaultHandler = 'phuongna\rabbitmq\Handlers\DefaultHandler';

    /**
     * The queue worker instance.
     *
     * @var phuongna\rabbitmq\Worker
     */
    protected $worker;
     ...
     *
     * @param  phuongna\rabbitmq\Worker  $worker
     * @return void
     */
